...
from qt_ui.widgets.spinsliders import (
    CurrencySpinner,
    FloatSpinSlider,
    TimeInputs,
    PercentSpinSlider,
...
class NewGameWizard(QtWidgets.QWizard):
    ...
    def accept(self):
        ...
        generator_settings = GeneratorSettings(
            ...
            squadron_random_chance=int(self.field("squadron_random_chance")),
        )
...
class GeneratorOptions(QtWidgets.QWizardPage):
    def __init__(self, parent=None):
        ...
        squadron_random_chance = PercentSpinSlider(0, 100, 50, divisor=1)
        self.registerField("squadron_random_chance", squadron_random_chance.spinner)
        ...
        generatorLayout.addLayout(squadron_random_chance, 9, 0)
        generatorHelpText = QtWidgets.QLabel(
            "<p>Aircraft type selection is governed by the campaign and the squadron definitions available to "
            + "Liberation. Squadrons are generated by Liberation if the faction does not have access to the campaign "
        ...
        generatorHelpText.setWordWrap(True)
        generatorLayout.addWidget(generatorHelpText, 10, 0)
        generatorHelpText.setAlignment(Qt.AlignLeft)
