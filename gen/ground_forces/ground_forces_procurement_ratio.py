class ground_forces_procurement_raito:
    ...
    # initial ratio based on a force of 10 M1A2, 6 Bradly, 2 MLRPS, 2 Avenger and 4 TOW which seemed feasible. Can be adjusted to resemble forces with different doctrines or wars
