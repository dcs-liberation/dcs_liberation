...
from game.utils import Distance, SPEED_OF_SOUND_AT_SEA_LEVEL, Speed, meter_to_nm
...
class GroundSpeed:
    ...
    def for_flight(cls, flight: Flight, altitude: Distance) -> int:
        ...
        mach = max_speed.to_mach(Distance.meters(0)) * 0.8
        return int(Speed.mach(mach, altitude).to_knots)
