...
SAM_PRICES = {
    AirDefence.Hawk_pcp: 35,
    AirDefence.ZU_23_Emplacement: 10,
    AirDefence.ZU_23_Emplacement_Closed: 10,
    AirDefence.Ural_375_ZU_23: 10,
    AirDefence.Ural_375_ZU_23_Insurgent: 10,
    AirDefence.ZU_23_Closed_Insurgent: 10,
    AirDefence.ZU_23_Insurgent: 10,
    AirDefence.ZSU_23_4_Shilka: 10,
    AirDefence.Vulcan: 15,
    AirDefence.M6_Linebacker: 20,
    AirDefence.Rapier_fsa_launcher: 20,
    AirDefence.M1097_Avenger: 22,
    AirDefence.Gepard: 24,
    AirDefence.Roland_ADS: 40,
    AirDefence.Patriot_ln: 85,
    AirDefence.Patriot_EPP: 85,
    AirDefence.M48_Chaparral: 25,
    AirDefence.Bofors40: 15,
    AirDefence.Flak36: 15,
    AirDefence.S_75M_Volhov: 30,
    AirDefence._5p73_s_125_ln: 35,
    AirDefence.Kub_2P25_ln: 45,
    AirDefence.Osa_9A33_ln: 30,
    AirDefence.Strela_1_9P31: 25,
    AirDefence.S_300PS_5P85D_ln: 80,
    AirDefence.S_300PS_54K6_cp: 80,
    AirDefence.SA_11_Buk_LN_9A310M1: 60,
    AirDefence.Strela_10M3: 30,
    AirDefence.Tor_9A331: 40,
    AirDefence._2S6_Tunguska: 35,
    AirDefence.HQ_7_LN_SP: 35,
}
