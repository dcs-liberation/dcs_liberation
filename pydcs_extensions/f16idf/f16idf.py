...
class WeaponsF16I:
    ...
    AIM_9P5_ = {"clsid": "{AIM-9P5}", "name": "AIM-9P5 ", "weight": 85.5}
    AIM_9P_ = {
    ...
    AN_AAQ_13 = {"clsid": "{ANAAQ-13}", "name": "AN/AAQ-13", "weight": 25}
    ...
    LAU_7_GAR_8_ = {"clsid": "{GAR-8}", "name": "LAU-7 GAR-8 ", "weight": 100.5}
    ...
    Python_5_ = {"clsid": "{AIM-9L}", "name": "Python-5 ", "weight": 85.5}
