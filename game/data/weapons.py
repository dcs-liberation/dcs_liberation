...
_WEAPON_FALLBACKS = [
    ...
    # AIM-9 Sidewinder
    (Weapons.GAR_8_Sidewinder_IR_AAM, None),
    (Weapons.AIM_9L_Sidewinder_IR_AAM, Weapons.GAR_8_Sidewinder_IR_AAM),
    ...
    (Weapons.LAU_7_GAR_8_Sidewinder_IR_AAM, None),
    (Weapons.LAU_7_AIM_9L, Weapons.LAU_7_GAR_8_Sidewinder_IR_AAM),
...
WEAPON_INTRODUCTION_YEARS = {
    ...
    # AIM-9 Sidewinder
    Weapon.from_pydcs(Weapons.GAR_8_Sidewinder_IR_AAM): 1956,
    ...
    Weapon.from_pydcs(Weapons.LAU_7_GAR_8_Sidewinder_IR_AAM): 1956,
    ...
    Weapon.from_pydcs(Weapons.LAU_7___2_GAR_8_Sidewinder_IR_AAM): 1956,
