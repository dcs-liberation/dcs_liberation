...
class Operation:
    ...
    def generate_lua(
        ...
        for cp in cls.game.theater.control_points_for(False):
            for ground_object in cp.ground_objects:
                if ground_object.might_have_aa:
                    for g in ground_object.groups:
                        ...
                        # threat_pos = ground_object.position + Point(threat_range.meters, threat_range.meters)
                        # threat_radius = ground_object.position.distance_to_point(threat_pos)

                        luaData["RedAA"][ground_object.group_name] = {
