...
class Faction:
    ...
    preset_groups: list[GroundForceGroup] = field(default_factory=list)
    ...
    def accessible_units(self) -> Iterator[UnitType[Any]]:
        if not self._accessible_units:
            self._load_accessible_units()
    ...
    def _load_accessible_units(self) -> None:
    ...
    def from_json(cls: Type[Faction], json: Dict[str, Any]) -> Faction:
        ...
        faction.preset_groups = [
            GroundForceGroup.named(n) for n in json.get("preset_groups", [])
        ]
